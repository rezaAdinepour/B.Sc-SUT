...
_0x3:
	.DB  0x61,0x64,0x69,0x6E,0x65,0x70,0x6F,0x75
	.DB  0x72
_0x0:
	.DB  0x72,0x65,0x7A,0x61,0x0
_0x2000003:
	.DB  0x80,0xC0
...
; 0000 0027         delay_ms(1000);
	...
	CALL _delay_ms
; 0000 0028 
; 0000 0029         for(i = 0; i < strlength; i++)
	CLR  R6
	CLR  R7
_0xF:
	MOV  R30,R5
	...
	BRGE _0x10
; 0000 002A         {
; 0000 002B             for(j = strlength + 1 - i; j <= 17; j++)
	MOV  R30,R5
	LDI  R31,0
	ADIW R30,1
	SUB  R30,R6
...
_0x12:
	...
	BRLT _0x13
; 0000 002C             {
; 0000 002D                 lcd_gotoxy(j - 1, 1);
	RCALL SUBOPT_0x1
; 0000 002E                 lcd_putchar(' ');
; 0000 002F                 lcd_gotoxy(j, 1);
; 0000 0030                 lcd_putchar(str[strlength - i]);
	RCALL SUBOPT_0x2
