...
_0x0:
	.DB  0x46,0x72,0x65,0x71,0x3D,0x25,0x33,0x2E
	.DB  0x30,0x66,0x0,0x20,0x48,0x7A,0x0,0x46
	.DB  0x72,0x65,0x71,0x3D,0x25,0x33,0x2E,0x32
	.DB  0x66,0x0,0x20,0x4B,0x48,0x7A,0x0
_0x2000000:
...
; .FSTART _timer0_ovf_isr
	...
	ST   -Y,R30
; 0000 0011   timer0_ov ++;
	LDI  R26,LOW(_timer0_ov)
	LDI  R27,HIGH(_timer0_ov)
	CALL __GETD1P_INC
	__SUBD1N -1
	CALL __PUTDP1_DEC
; 0000 0012 }
...
; 0000 0025       freq = timer0_ov * 256 + TCNT0;
	LDS  R30,_timer0_ov
	LDS  R31,_timer0_ov+1
	LDS  R22,_timer0_ov+2
	LDS  R23,_timer0_ov+3
	__GETD2N 0x100
	CALL __MULD12
	MOVW R26,R30
	MOVW R24,R22
...
; 0000 0037       timer0_ov=0;   //Prepare for next count
	STS  _timer0_ov,R30
	STS  _timer0_ov+1,R30
	STS  _timer0_ov+2,R30
	STS  _timer0_ov+3,R30
