...
_0x0:
	...
	.DB  0x61,0x6D,0x65,0x20,0x6F,0x66,0x0
_0x2000003:
	.DB  0x80,0xC0
...
_0x3:
; 0000 003A       {
; 0000 003B       lcd_gotoxy(1,0);
	LDI  R30,LOW(1)
	ST   -Y,R30
	LDI  R26,LOW(0)
	RCALL _lcd_gotoxy
; 0000 003C       lcd_puts("In the name of");
	__POINTW2MN _0x6,0
	RCALL _lcd_puts
; 0000 003D 
...
_0xB:
	...
	CPC  R31,R19
	BRLT _0xC
; 0000 0040             lcd_gotoxy(j-1,1);
	RCALL SUBOPT_0x0
; 0000 0041             lcd_putchar(' ');
; 0000 0042             lcd_gotoxy(j,1);
; 0000 0043             lcd_putchar(s[2-i]);
...
_0x11:
	__CPWRN 18,19,17
	BRGE _0x12
; 0000 004A             lcd_gotoxy(j-1,1);
	RCALL SUBOPT_0x0
; 0000 004B             lcd_putchar(' ');
; 0000 004C             lcd_gotoxy(j,1);
; 0000 004D             lcd_putchar(s[2-i]);
