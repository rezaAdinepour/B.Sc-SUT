...
; .FSTART _timer1_ovf_isr
	ST   -Y,R30
; 0000 0008 // Reinitialize Timer1 value
; 0000 0009 TCNT1H=0xFCE0 >> 8;
	LDI  R30,LOW(252)
	OUT  0x2D,R30
; 0000 000A TCNT1L=0xFCE0 & 0xff;
	LDI  R30,LOW(224)
	OUT  0x2C,R30
...
; 0000 0044 TCCR1A=(0<<COM1A1) | (1<<COM1A0) | (0<<COM1B1) | (0<<COM1B0) | (0<<WGM11) | (0<<WGM10);
	LDI  R30,LOW(64)
	OUT  0x2F,R30
; 0000 0045 TCCR1B=(0<<ICNC1) | (0<<ICES1) | (0<<WGM13) | (0<<WGM12) | (0<<CS12) | (0<<CS11) | (1<<CS10);
	LDI  R30,LOW(1)
	OUT  0x2E,R30
; 0000 0046 TCNT1H=0xFC;
	LDI  R30,LOW(252)
	OUT  0x2D,R30
; 0000 0047 TCNT1L=0xE0;
	LDI  R30,LOW(224)
	OUT  0x2C,R30
...
; 0000 0072 ADCSRA=(0<<ADEN) | (0<<ADSC) | (0<<ADATE) | (0<<ADIF) | (0<<ADIE) | (0<<ADPS2) | (0<<ADPS1) | (0<<ADPS0);
	OUT  0x6,R30
; 0000 0073 
