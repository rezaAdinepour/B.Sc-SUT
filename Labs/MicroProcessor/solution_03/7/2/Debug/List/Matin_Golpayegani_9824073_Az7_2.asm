...
; 0000 0033 // Timer Period: 0.05 ms
; 0000 0034 // Output Pulse(s):
; 0000 0035 // OC1A Period: 0.1 ms Width: 0.05 ms
...
; 0000 003A TCCR1A=(0<<COM1A1) | (1<<COM1A0) | (0<<COM1B1) | (0<<COM1B0) | (0<<WGM11) | (0<<WGM10);
	LDI  R30,LOW(64)
	OUT  0x2F,R30
; 0000 003B TCCR1B=(0<<ICNC1) | (0<<ICES1) | (0<<WGM13) | (1<<WGM12) | (0<<CS12) | (0<<CS11) | (1<<CS10);
	LDI  R30,LOW(9)
	OUT  0x2E,R30
...
; 0000 003F ICR1L=0x00;
	OUT  0x26,R30
; 0000 0040 OCR1AH=0x01;
	LDI  R30,LOW(1)
	OUT  0x2B,R30
; 0000 0041 OCR1AL=0x8F;
	LDI  R30,LOW(143)
	OUT  0x2A,R30
